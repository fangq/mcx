...
void mcx_preprocess(Config* cfg) {
    ...
    if ((cfg->outputtype == otJacobian || cfg->outputtype == otWP || cfg->outputtype == otDCS || cfg->outputtype == otRF || cfg->outputtype == otRFmus || gcfg->outputtype == otWLTOF)
...
void mcx_loadseedfile(Config* cfg) {
    ...
    if (cfg->outputtype == otJacobian || cfg->outputtype == otWP || cfg->outputtype == otDCS  || cfg->outputtype == otRF || cfg->outputtype == otRFmus || gcfg->outputtype == otWLTOF) { //cfg->replaydet>0
        int i, j, hasdetid = 0, offset;
        float plen, *ppath;
...
void mcx_parsecmd(int argc, char* argv[], Config* cfg) {
    ...
    if ((cfg->outputtype == otJacobian || cfg->outputtype == otWP || cfg->outputtype == otDCS  || cfg->outputtype == otRF || cfg->outputtype == otRFmus || gcfg->outputtype == otWLTOF) && cfg->seed != SEED_FROM_FILE) {
